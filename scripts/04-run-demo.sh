...
echo ""
echo "NOTE: Full CBT block-level backup and restore to S3 is implemented in"
echo "      tools/cbt-backup/ and tools/cbt-restore/. Deploy as Kubernetes Jobs:"
echo "      kubectl apply -f manifests/backup-restore/backup-job.yaml"
