...
echo ""
echo "Next steps:"
echo "  1. Deploy MinIO: ./scripts/01-deploy-minio.sh"
echo "  2. Install Snapshot CRDs (if not already installed)"
echo "  3. Deploy CSI Driver: ./scripts/02-deploy-csi-driver.sh"
echo "  4. Deploy workload: ./scripts/03-deploy-workload.sh"
echo ""
