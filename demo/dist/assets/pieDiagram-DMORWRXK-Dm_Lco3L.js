import{p as U}from"./chunk-K2ZEYYM2-CxIrYIA0.js";import{p as Q}from"./treemap-KMMF4GRG-YVX6V4UE-BDb5wrCJ.js";import{a as s,g as V,s as Z,b as j,c as q,v as H,t as J,l as w,d as K,G as X,aO as Y,aQ as ee,aR as G,aS as te,f as ae,A as re,aT as ie,I as se}from"./Mermaid.vue_vue_type_script_setup_true_lang-DtbCt0he.js";import"./chunk-ZZTYOBSU-c-ELl7kA.js";import"./index-2JM-T1bm.js";import"./modules/vue-CoVZSFTd.js";import"./modules/shiki-D8j2JMkf.js";import"./modules/file-saver-B8IIMB9x.js";var le=se.pie,D={sections:new Map,showData:!1},g=D.sections,C=D.showData,oe=structuredClone(le),ne=s(()=>structuredClone(oe),"getConfig"),ce=s(()=>{g=new Map,C=D.showData,re()},"clear"),pe=s(({label:e,value:a})=>{if(a<0)throw new Error(`"${e}" has invalid value: ${a}. Negative values are not allowed in pie charts. All slice values must be >= 0.`);g.has(e)||(g.set(e,a),w.debug(`added new section: ${e}, with value: ${a}`))},"addSection"),de=s(()=>g,"getSections"),ge=s(e=>{C=e},"setShowData"),ue=s(()=>C,"getShowData"),O={getConfig:ne,clear:ce,setDiagramTitle:J,getDiagramTitle:H,setAccTitle:q,getAccTitle:j,setAccDescription:Z,getAccDescription:V,addSection:pe,getSections:de,setShowData:ge,getShowData:ue},fe=s((e,a)=>{U(e,a),a.setShowData(e.showData),e.sections.map(a.addSection)},"populateDb"),he={parse:s(async e=>{const a=await Q("pie",e);w.debug(a),fe(a,O)},"parse")},me=s(e=>`
  .pieCircle{
